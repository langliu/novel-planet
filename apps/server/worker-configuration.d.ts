/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 0c2e7580fb586cea2ff67a35a3a759e8)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CLOUDFLARE_R2_SECRET_ID: string;
		CLOUDFLARE_R2_SECRET: string;
		R2: R2Bucket;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "CORS_ORIGIN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "CLOUDFLARE_R2_TOKEN" | "CLOUDFLARE_R2_SECRET_ID" | "CLOUDFLARE_R2_SECRET">> {}
}
